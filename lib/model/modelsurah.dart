...
List<Modelsurah> breweryModelFromJson(String str) => List<Modelsurah>.from(
    json.decode(str).map((x) => Modelsurah.fromJson(x)));

String breweryModelToJson(List<Modelsurah> data) =>
